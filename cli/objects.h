...
/**
 * struct CliHelp - Command Line Help options
 */
struct CliHelp
{
...
/**
 * struct CliConfig - Command Line Config options
 */
struct CliConfig
{
  bool is_set;                      ///< This struct has been used
...
/**
 * struct CliLogging - Command Line Loggin options
 */
struct CliLogging
{
  bool is_set;                      ///< This struct has been used
...
/**
 * struct CliInfo - Command Line Info options
 */
struct CliInfo
{
  bool is_set;                      ///< This struct has been used
...
/**
 * struct CliSend - Command Line Send options
 */
struct CliSend
{
  bool is_set;                      ///< This struct has been used
...
/**
 * struct CliGui - Command Line GUI options
 */
struct CliGui
{
  bool is_set;                      ///< This struct has been used
...
/**
 * struct CommandLine - Command Lineoptions
 */
struct CommandLine
{
  struct CliHelp    help;          ///< Help    command line options
  struct CliConfig  config;        ///< Config  command line options
  struct CliLogging logging;       ///< Logging command line options
  struct CliInfo    info;          ///< Info    command line options
  struct CliSend    send;          ///< Send    command line options
  struct CliGui     gui;           ///< Gui     command line options
};
